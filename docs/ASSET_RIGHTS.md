# Asset and media rights record

This record must be completed against the final exported video and submission gallery.
...
| Male English narration | Higgsfield Seed Audio 1.0 with Kevin preset, generated on 2026-09-10 | Connected Higgsfield Max workspace output; voice id `f1373f24-3b96-433f-9a68-e595810ef608`; accepted job ids recorded below | Complete |
| Background instrumental | Higgsfield Sonilo Music, generated for DoorSignal on 2026-09-10 | Original text-to-music output from the connected Higgsfield Max workspace; job id `6e0ad4dd-6d72-46c5-ad17-bc5825e47288`; no stock recording or attribution requirement introduced | Complete |
| Captions | Sentence-timed from the final DoorSignal narration and exported as UTF-8 SRT plus open captions | Original project text; rendered and decoded successfully | Complete |
